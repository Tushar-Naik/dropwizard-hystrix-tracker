...
package io.dropwizard.hystrix.path.tracker.application;

import io.dropwizard.Application;
import io.dropwizard.hystrix.path.tracker.TrackerBundle;
...
public class TestApp extends Application<TestConfiguration> {
    ...
    public void initialize(Bootstrap<TestConfiguration> bootstrap) {
        bootstrap.addBundle(new TrackerBundle<TestConfiguration>() {
