...
/**
 * Use this Annotation on resource methods, that need to be wrapped by a SEMAPHORE based Tracking HystrixCommand
 *
 * @author tushar.naik
 * @version 1.0
 * @see PathTrackerFilter , RuntimeFeature
 * @since 19/10/16 - 8:15 AM
 */
@NameBinding
